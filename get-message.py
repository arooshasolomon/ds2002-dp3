...
url = "https://sqs.us-east-1.amazonaws.com/440848399208/npj4qa"
...
def get_message():
    ...
    for values in range(queue_message):
        try:
            ...
            if "Messages" in response:
                ...
                message_storage.update(message)

                delete_message(handle)
            # If there is no message in the queue, print a message and continue    
            else:
